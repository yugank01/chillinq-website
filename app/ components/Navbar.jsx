...
const Navbar = () => {
  ...
  return (
    ...
    ${navbarBgColor} transition-all ease-in-out duration-300`}>
      ...
      <div className={`delay-300 md:hidden h-screen bg-black/75 w-full fixed top-[66px] text-left container mx-auto flex flex-wrap p-5 items-center flex-col ${Toggle? 'right-[100%]':'left-[100%]}'}`}>
      ...
      {Toggle ? <img src="/hamburger (1).png" alt="" className="z-0 md:hidden h-[30px] pr-[20px]" onClick={handleClick} /> : <img src="/close.png" alt="" className="z-0 md:hidden h-[30px] pr-[20px]" onClick={handleClick}/>}
    </header>
  );
};
